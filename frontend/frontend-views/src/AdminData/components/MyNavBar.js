...
const MyNavbar2 = () => {
  ...
  return (
      <div className="navbar2">
        ...
        <NavLink to="/adminpage" className="nav-button2">Autores</NavLink>
        <NavLink to="/adminpage" className="nav-button2">Libros</NavLink>  
        <NavLink to="/adminpage" className="nav-button2">Historial de Compras</NavLink> 
